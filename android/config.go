...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.Lite.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.LiteConfig.JavaSourceOverlayModuleWhitelist
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Lite.Specific_camera_parameter_library)
}
